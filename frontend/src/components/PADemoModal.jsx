...
const PADemoModal = ({ pa, onClose, api }) => {
  ...
  useEffect(() => {
    ...
    // Auto-run if no params (but NOT for PA3/PA8/PA9/PA10/PA11/PA18 — they have their own special renderers)
    if (def.params.length === 0 && pa.pa !== 3 && pa.pa !== 8 && pa.pa !== 9 && pa.pa !== 10 && pa.pa !== 11 && pa.pa !== 18) {
      ...
      <div className="modal">
        ...
        <div className="modal-body">
          <div style={{ marginBottom: '20px', paddingBottom: '16px', borderBottom: '1px solid var(--border)' }}>
            ...
            {!isPaDemo1 && !isPaDemo2 && !isPaDemo3 && !isPaDemo8 && !isPaDemo9 && !isPaDemo10 && !isPaDemo11 && !isPaDemo13 && !isPaDemo18 && (
          ...
          <div id="demoOutputContainer">
            {isLoading && !isPaDemo1 && !isPaDemo3 && !isPaDemo7 && !isPaDemo8 && !isPaDemo9 && !isPaDemo10 && !isPaDemo11 && !isPaDemo13 && !isPaDemo18 && <div style={{ textAlign: 'center', padding: '20px' }}><div className="spinner"></div></div>}
            {error && <pre style={{ color: 'var(--red)' }}>{error}</pre>}
            {isPaDemo7 ? renderPA7Special() : isPaDemo1 ? renderPA1Special() : isPaDemo2 ? renderPA2Special() : isPaDemo3 ? renderPA3Special() : isPaDemo8 ? renderPA8Special() : isPaDemo9 ? renderPA9Special() : isPaDemo10 ? renderPA10Special() : isPaDemo11 ? renderPA11Special() : isPaDemo13 ? renderPA13Special() : isPaDemo18 ? renderPA18Special() : (result && renderResult(result))}
          </div>
        </div>
      </div>
    </div>
